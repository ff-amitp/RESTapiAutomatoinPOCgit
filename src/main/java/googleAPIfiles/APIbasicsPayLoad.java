		...
		public static String postGoogleDataFirstPlaceXML() throws IOException
			{
				...
				return APIbasicsReusableMethods.GenerateStringFromResource(System.getProperty ("user.dir") +"\\Misc Files\\postGoogleDataFirstPlaceXML.xml");
		...
		public static String postGoogleDataSecondPlaceXML() throws IOException
			{
				...
				return APIbasicsReusableMethods.GenerateStringFromResource(System.getProperty ("user.dir") +"\\Misc Files\\postGoogleDataSecondPlaceXML.xml");
			}
		...
		public static String deleteGoogleDataXML() throws IOException
			{
			    ...
			    return APIbasicsReusableMethods.GenerateStringFromResource(System.getProperty ("user.dir") +"\\Misc Files\\deleteGoogleDataXML.xml");
			}
	}
